...
const (
    ...
    ER_CLIENT_REQ_ROW_PRIV_CHECKS_USER_NOT_NULL                     = 3946
    ER_CLIENT_PRIV_CHECKS_REQUIRE_ROW_FORMAT_NOT_SET                = 3947
    ER_FAILED_TO_DETERMINE_IF_ROLE_IS_MANDATORY                     = 3948
    ER_FAILED_TO_FETCH_MANDATORY_ROLE_LIST                          = 3949
    ER_CLIENT_LOCAL_FILES_DISABLED                                  = 3950
    ER_IMP_INCOMPATIBLE_CFG_VERSION                                 = 3951
    ER_DA_OOM                                                       = 3952
    ER_DA_UDF_INVALID_ARGUMENT_TO_SET_CHARSET                       = 3953
    ER_DA_UDF_INVALID_RETURN_TYPE_TO_SET_CHARSET                    = 3954
    ER_MULTIPLE_INTO_CLAUSES                                        = 3955
    ER_MISPLACED_INTO                                               = 3956
    ER_USER_ACCESS_DENIED_FOR_USER_ACCOUNT_BLOCKED_BY_PASSWORD_LOCK = 3957
    ER_WARN_DEPRECATED_YEAR_UNSIGNED                                = 3958
    ER_CLONE_NETWORK_PACKET                                         = 3959
)
